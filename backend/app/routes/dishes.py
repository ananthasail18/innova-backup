...
def get_dishes(category_id: Optional[str] = None, restaurant_id: Optional[str] = None, db: Session = Depends(get_db)):
    ...
    if category_id:
        ...
        dishes = dish_repo.get_all_by_restaurant(target_restaurant_id)
